...
- [Rhythm Heaven Groove](https://www.nintendo.com/us/store/products/rhythm-heaven-groove-switch/), Switch/Switch 2 - accessible by default, first option when booting up the game is how much voiceover you want. Options include reading on-screen text, reading all on-screen text and image descriptions (such as characters), or no reading at all.
